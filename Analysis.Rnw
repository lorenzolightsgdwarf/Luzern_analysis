...
qplot(data=subset(DF_Duration,Duration/1000<250),x=Trial,y=Duration/1000, fill=Condition, geom="boxplot")+labs(x="Trial",y="Duration (s)")+scale_fill_manual(values=c("#00bfc4", "#f8766d"), name="Feedback", breaks = c("tangible", "static"),labels=c("Tangible","Verbal"))+theme(text = element_text(size=20))
